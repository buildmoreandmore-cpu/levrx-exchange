    ...
    <section className="relative min-h-screen w-full bg-white overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 pt-32 pb-16 sm:pt-40 sm:pb-20">
        <div className="text-center">
          ...
          {/* Subheadline */}
          <p className="mx-auto mb-12 max-w-3xl text-lg md:text-xl text-slate-500 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5">
            ...
            <button 
              className="inline-flex h-14 w-full sm:w-auto items-center justify-center gap-3 rounded-lg bg-blue-600 px-8 py-4 text-base font-semibold text-white shadow-md transition-all duration-200 hover:bg-blue-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
